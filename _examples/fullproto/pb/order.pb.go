...
func (x *OrderCreated) GetAt() *timestamp.Timestamp {
	if x != nil {
		return x.At
	}
	return nil
...
func (x *OrderShipped) GetAt() *timestamp.Timestamp {
	if x != nil {
		return x.At
	}
	return nil
...
var file_order_proto_depIdxs = []int32{
	2, // 0: pb.OrderCreated.at:type_name -> google.protobuf.Timestamp
	2, // 1: pb.OrderShipped.at:type_name -> google.protobuf.Timestamp
