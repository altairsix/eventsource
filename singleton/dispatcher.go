...
type Dispatcher interface {
	...
	Dispatch(ctx context.Context, command eventsource.Command) (int, error)
}

// DispatcherFunc provides a convenience func form of Dispatcher
type DispatcherFunc func(ctx context.Context, command eventsource.Command) (int, error)

// Dispatch satisfies the Dispatcher interface
func (fn DispatcherFunc) Dispatch(ctx context.Context, command eventsource.Command) (int, error) {
